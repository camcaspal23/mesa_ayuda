    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Lista de Tickets Aperturados</h1>
          <p>Esta es la lista total de tickets aperturados por el cliente a falta de solucion. esta vista pertenece a los usuario tipo Cliente</p>
        </div>
