...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p>Esta es la lista total de tickets pendientes de solucion. esta vista pertenece a los usuario tipo
                Empleado</p>
        </div>
                            ...
                            ($this->modelo->ListarAbierto() as $r): ?>
                                <tr>
                                   ...
                                   <!-- <td><?=$r->TipoAprobacion?></td>-->
                                    ...
                                    <td><a href="?c=ticket&a=SolucionarEmpleado&id=<?= $r->idTicket ?>">Solucionar
                                            | </a><a href="?c=ticket&a=SeguimientoEmpleado&id=<?= $r->idTicket ?>">Seguimiento</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
