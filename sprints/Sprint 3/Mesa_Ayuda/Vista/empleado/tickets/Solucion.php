            ...
            <div class="tile-body">
                <form class="form-horizontal" action="?c=ticket&a=Actualizar" method="POST">
                    <div class="form-group row">
                        ...
                        <input type="hidden" name="Seguimiento" value="<?= $p->getSeguimiento() ?>">
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="estado">
                                <option value="<?= $p->getIdAprobacion() ?>">Sin Categoria</option>
                                ...
                                <option value="2">Tecnologico</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="tipon">
                                <option value="<?= $p->getIdNivelCaso() ?>">Sin Nivel</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" name="Seguimiento" rows="3"
                                      readonly="readonly"><?= $p->getSeguimiento() ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-3">
                                <button class="btn btn-primary" name="registrar" type="submit"><i
                                            class="fa fa-fw fa-lg fa-check-circle"></i>Solucionar
                            </div>
                        </div>
                    </div>
                </form>
