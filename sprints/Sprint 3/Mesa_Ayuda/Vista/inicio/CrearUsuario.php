            ...
            <div class="tile-body">
                <form class="form-horizontal" action="?c=UsuariosCreacion&a=Guardar" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="nombre" type="text" value="<?= $u->getNombre() ?>"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="tipoD">
                                ...
                                <option value="2">Cédula de Extranjera</option>
                                <option value="3">Pasaporte Colombiano</option>
                                <option value="4">Pasaporte Extranjero</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="Identificacion" type="text"
                                   value="<?= $u->getIdentificacion() ?>" placeholder="Identificacion">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-3">Usuario</label>
                        <div class="col-md-8">
                            <input class="form-control" name="usuario" type="text" value="<?= $u->getUsuario() ?>"
                                   placeholder="Usuario">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="passNormal" type="password"
                                   value="<?= $u->getContraseniaNormal() ?>" placeholder="Contraseña">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-3">Validar Contraseña</label>
                        <div class="col-md-8">
                            <input class="form-control" name="passEncriptada" type="password"
                                   value="<?= $u->getContraseniaEncriptada() ?>" placeholder="Contraseña">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-3">
                                <button class="btn btn-primary" name="registrar" type="submit"><i
                                            class="fa fa-fw fa-lg fa-check-circle"></i><?= $titBoton ?>
                            </div>
                        </div>
                    </div>
                </form>
