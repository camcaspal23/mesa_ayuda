            ...
            <div class="tile-body">
              <form class="form-horizontal" action="?c=ticket&a=ActualizarSeguimiento" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" name="Seguimiento" rows="3"><?=$p->getSeguimiento()?></textarea>
                  </div>
                </div>
                <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" name="registrar" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Realizar Seguimiento
                </div>
              </div>
            </div> 
<!--Datos hidden-->
